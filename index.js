...
function showRandomMovie(){
    let movieList = ["Hot Tub Time Machine", "Mugen Train", "Movie the Movie"]
    let choice = Math.floor(Math.random() * movieList.length)
    console.log(`Tonight's pick: ${movieList[choice]}`)
}
showRandomMovie()
// ============================================================
